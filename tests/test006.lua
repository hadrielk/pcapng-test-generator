...
function test:compile()
    ...
    self.blocks = {
        ...
        block.EPB( idb1, input:getData(5),     timestamp + 1000 ),
        block.EPB( idb0, input:getData(2,96),  timestamp + 2000 ),
        block.EPB( idb0, input:getData(3,96),  timestamp + 3000 ),
        block.EPB( idb0, input:getData(4,96),  timestamp + 4000 ),
    }
end
